    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #d14d72 0%, #a855a0 25%, #7c3aed 50%, #4338ca 75%, #1e3a8a 100%);
            min-height: 100vh;
            color: #ffffff;
            overflow-x: hidden;
        }
        ...
        .btn-primary {
            background: linear-gradient(45deg, #a855a0, #4338ca);
            color: #ffffff;
            box-shadow: 0 5px 15px rgba(168, 85, 160, 0.5);
            width: 100%;
        }

        .btn-primary:hover {
            background: linear-gradient(45deg, #9333ea, #3730a3);
            transform: translateY(-3px);
            box-shadow: 0 8px 25px rgba(168, 85, 160, 0.7);
        }
        ...
        .nav-item.active {
            background: rgba(255, 255, 255, 1);
            border-color: #a855a0;
            box-shadow: 0 3px 10px rgba(168, 85, 160, 0.4);
        }
                            ...
                            <div class="message-item sent" onclick="viewMessage(${message.messageId})">
                                ...
                                <div class="message-content">
                                    <div class="message-header">
                                        <span class="recipient-name">To: <c:out value="${message.recipientName}" escapeXml="true"/></span>
